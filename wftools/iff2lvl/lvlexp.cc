...
#include "global.hp"
#include "lvlexp.hp"	// C++ header file
...
#endif
{
	...
	if ( GetLocalMachineStringRegistryEntry("Software\\Recombinant\\World Foundry\\GDK\\max2lvl","OPTIONS",optionsBuffer,MAX_CMD_LINE) )
	{
	...
	if (!GetLocalMachineStringRegistryEntry("Software\\Recombinant\\World Foundry\\GDK","OAD_DIR",OADdir,_MAX_PATH))
	{
