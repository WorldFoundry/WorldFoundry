//==============================================================================
// profile.cc: Copyright (c) 1996-1999, World Foundry Group  
...
static bool FindLine(FILE *, char *, char *, char *, FILE *);
static bool FindApp(FILE *, char *, FILE *);
...
static bool
FindApp( FILE *fp, char *lpApplicationName, FILE *fpo )
	{
	char szMatch[100];
	char szBuff[4096];
...
static bool
FindLine( FILE *fp, char * lpKeyName, char * lpApplicationName, char *szLine, FILE *fpo )
	{
	char szMatch[100];
	char szBuff[4096];
 ...
 */
int
GetPrivateProfileInt( char* lpApplicationName, char* lpKeyName, int nDefault, char* lpFileName )
	{
	FILE *fp;
	char szLine[4096];
 ...
 */
int
GetPrivateProfileString( char* lpApplicationName, char* lpKeyName, char* lpDefault, char* lpReturnedString, int nSize, char* lpFileName )
	{
	FILE *fp;
	char szLine[4096];
	int nReturn;
 ...
 */
bool
WritePrivateProfileString( char *lpApplicationName, char *lpKeyName, char *lpString, char *lpFileName )
	{
	FILE *fp;
	FILE *fpo;
	char szTempName[13];
...
bool
WritePrivateProfileInt( char *lpApplicationName, char *lpKeyName, int nValue, char *lpFileName )
	{
	char szBuff[4096];
