...
// kts compute center of object for purposes of determining if one object is in another (rooms)
	...
	DBSTREAM3( cdebug << "QRoom::InsideCheck: point is" << point << ", from colbox: " << object->GetColBox() << endl; )
	DBSTREAM3( cdebug << " Would have used  point" << object->Position(); )
...
void
QRoom::Save(FILE* fp,const QLevel& level)
{
...
//			DBSTREAM3( cdebug << "QRoom::Save: adjacent room index <" << adjRoomIndex << "> set to <" << diskRoom->adjacentRooms[adjRoomIndex] << ">" << endl; )
	...
	cdebug << "room save really done" << endl;
