...
QFile3ds::QFile3ds(const char* filename)
{
...
void
QFile3ds::LoadChunkData(chunk3ds* chunk)
{
...
void
QFile3ds::DumpChunk3DS(chunk3ds* chunk, int indent, short dumpSib, const char* name)
{

//	cout << "chunk3DS dump:" << endl;
...
//============================================================================
// returns chunk3ds* if found, NULL if not

chunk3ds*
QFile3ds::FindXDataChunk(chunk3ds* mesh) const
{
	chunk3ds* chunk;
...
chunk3ds*
QFile3ds::FindNamedXDataChunk(chunk3ds* xDataChunk,const char* name)
{
	chunk3ds* dataChunk;
	chunk3ds* nameChunk;
...
ulong3ds
QFile3ds::GetChunkDataSize(chunk3ds* chunk) const
{
	return(chunk->size);
}
...
void
QFile3ds::GetChunkData(chunk3ds* chunk,char* destBuffer) const
{
