...
//	randomize();
	...
	DBSTREAM3( cdebug << "RotationConvert:initial values" << endl; )
	...
	DBSTREAM3( cdebug << "r = " << r << "\tx = " << x << "\ty = " << y << "\tz = " << z << endl; )
	DBSTREAM3( cdebug << "		a = " << a << "	b = " << b << "	c = " << c << endl; )
	DBSTREAM3( cdebug << "		Xa = " << Xa << "	Xb = " << Xb << "	Xc = " << Xc << endl; )
	DBSTREAM3( cdebug << "		Ya = " << Ya << "	Yb = " << Yb << "	Yc = " << Yc << endl; )
	DBSTREAM3( cdebug << "		Za = " << Za << "	Zb = " << Zb << "	Zc = " << Zc << endl; )

	DBSTREAM3( cdebug << "rotate Z -> Y" << endl; )
	...
	DBSTREAM3( cdebug << "r1 = " << r1 << "\tx1 = " << x1 << "\ty1 = " << y1 << "\tz1 = " << z1 << endl; )
	DBSTREAM3( cdebug << "		a1 = " << a1 << "	b1 = " << b1 << "	c1 = " << c1 << endl; )
	DBSTREAM3( cdebug << "		Xa1 = " << Xa1 << "	Xb1 = " << Xb1 << "	Xc1 = " << Xc1 << endl; )
	DBSTREAM3( cdebug << "		Ya1 = "	<< Ya1 << " Yb1 = " << Ya1 << "	Yc1 = " << Yc1 << endl; )
	DBSTREAM3( cdebug << "		Za1 = " << Za1 << "	Zb1 = " << Zb1 << "	Zc1 = " << Zc1 << endl; )

	DBSTREAM3( cdebug << "rotate X -> Y" << endl; )
	...
	Zc2 = Zc1;
	DBSTREAM3( cdebug << "r2 = " << r2 << "\tx2 = " << x2 << "\ty2 = " << y2 << "\tz2 = " << z2 << endl; )
	DBSTREAM3( cdebug << "		a2 = " << a2 << "	b2 = " << b2 << "	c2 = " << c2 << endl; )
	DBSTREAM3( cdebug << "		Xa2 = " << Xa2 << "	Xb2 = " << Xb2 << "	Xc2 = " << Xc2 << endl; )
	DBSTREAM3( cdebug << "		Ya2 = " << Ya2 << "	Yb2 = " << Yb2 << "	Yc2 = " << Yc2 << endl; )
	DBSTREAM3( cdebug << "		Za2 = " << Za2 << "	Zb2 = " << Zb2 << "	Zc2 = " << Zc2 << endl; )

	DBSTREAM3( cdebug << "rotate Z -> X (this is our initial input rotation)" << endl; )
	r3 = r;
	...
	DBSTREAM3( cdebug << "r3 = " << r3 << "\tx3 = " << x3 << "\ty3 = " << y3 << "\tz3 = " << z3 << endl; )
	DBSTREAM3( cdebug << "		a3 = " << a3 << "	b3 = " << b3 << "	c3 = " << c3 << endl; )
	DBSTREAM3( cdebug << "		Xa3 = " << Xa3 << "	Xb3 = " << Xb3 << "	Xc3 = " << Xc3 << endl; )
	DBSTREAM3( cdebug << "		Ya3 = " << Xb3 << "	Yb3 = " << Yb3 << "	Yc3 = " << Yc3 << endl; )
	DBSTREAM3( cdebug << "		Za3 = " << Xc3 << "	Zb3 = " << Zb3 << "	Zc3 = " << Zc3 << endl; )
	...
	Zc4 = Zc3;
	DBSTREAM3( cdebug << "r4 = " << r4 << "\tx4 = " << y4 << "\ty4 = " << z4 << endl; )
	DBSTREAM3( cdebug << "		a4 = " << a4 << "	b4 = " << b4 << "	c4 = " << c4 << endl; )
	DBSTREAM3( cdebug << "		Xa4 = " << Xa4 << "	Xb4 = " << Xb4 << "	Xc4 = " << Xc4 << endl; )
	DBSTREAM3( cdebug << "		Ya4 = " << Ya4 << "	Yb4 = " << Yb4 << "	Yc4 = " << Yc4 << endl; )
	DBSTREAM3( cdebug << "		Za4 = " << Za4 << "	Zb4 = " << Zb4 << "	Zc4 = " << Zc4 << endl; )

	DBSTREAM3( cdebug << "reverse rotate Z -> Y" << endl; )
	r5 = -r1;
	x5 = x4;
	...
	DBSTREAM3( cdebug << "r5 = " << r5 << "\tx5 = " << "\ty5 = " << y5 << "\tz5 = " << z5 << " (= x y z)" << endl; )
	DBSTREAM3( cdebug << "		a5 = " << a5 << "	b5 = " << b5 << "	c5 = " << c5 << endl; )
	DBSTREAM3( cdebug << "		Xa5 = " << Xa5 << "	Xb5 = " << Xb5 << "	Xc5 = " << Xc5 << endl; )
	DBSTREAM3( cdebug << "		Ya5 = " << Ya5 << "	Yb5 = " << Yb5 <<  "	Yc5 = " << Yc5 << endl; )
	DBSTREAM3( cdebug << "		Za5 = " << Za5 << "	Zb5 = " << Zb5 << "	Zc5 = " << Zc5 << endl; )

	DBSTREAM3( cdebug << "\nWe now have our rotated points." << endl; )
	DBSTREAM3( cdebug << "Now let's work backwards to get a X Y Z rotation...\n" << endl; )

	DBSTREAM3( cdebug << "Zrotate Y -> X to get unitX into XZ plane" << endl; )
...
//	}
	...
	Zc6 = Zc5;
	DBSTREAM3( cdebug << "Zr = " << Zr << endl; )
	DBSTREAM3( cdebug << "r6 = " << r6 << "\tx6 = " << x6 << "\ty6 = " << y6 << "\tz6 = " << z6 << endl; )
	DBSTREAM3( cdebug << "		a6 = " << a6 << "	b6 = " << b6 << "	c6 = " << c6 << endl; )
	DBSTREAM3( cdebug << "		Xa6 = " << Xa6 << "	Xb6 = " << Xb6 << "	Xc6 = " << Xc6 << endl; )
	DBSTREAM3( cdebug << "		Ya6 = " << Ya6 << "	Yb6 = " << Yb6 << "	Yc6 = " << Yc6 << endl; )
	DBSTREAM3( cdebug << "		Za6 = " << Za6 << "	Zb6 = " << Zb6 << "	Zc6 = " << Zc6 << endl; )

	DBSTREAM3( cdebug << "Yrotate Z -> X to get unitX into X axis" << endl; )
...
//	}
	...
	DBSTREAM3( cdebug << "Yr = " << Yr << endl; )
	DBSTREAM3( cdebug << "r7 = " << r7 << "\tx7 = " << x7 << "\ty7 = " << y7 << "\tz7 = " << z7 << endl; )
	DBSTREAM3( cdebug << "		a7 = " << a7 << "	b7 = " << b7 << "	c7 = " << c7 << endl; )
	DBSTREAM3( cdebug << "		Xa7 = " << Xa7 << "	Xb7 = " << Xb7 << "	Xc7 = " << Xc7 << endl; )
	DBSTREAM3( cdebug << "		Ya7 = " << Ya7 << "	Yb7 = " << Yb7 << "	Yc7 = " << Yc7 << endl; )
	DBSTREAM3( cdebug << "		Za7 = " << Za7 << "	Zb7 = " << Zb7 << "	Zc7 = " << Zc7 << endl; )

	DBSTREAM3( cdebug << "Xrotate Z -> Y to get unitY and unitZ into axis" << endl; )
...
//	}
	...
	DBSTREAM3( cdebug << "Xr = " << Xr << endl; )
	DBSTREAM3( cdebug << "r8 = " << r8 << "\tx8 = " << x8 << "\ty8 = " << y8 << "\tz8 = " << z8 << endl; )
	DBSTREAM3( cdebug << "		a8 =  " << a8  << "	b8 =  " << b8  << "	c8 =  " << c8  << endl; )
	DBSTREAM3( cdebug << "		Xa8 = " << Xa8 << "	Xb8 = " << Xb8 << "	Xc8 = " << Xc8 << endl; )
	DBSTREAM3( cdebug << "		Ya8 = " << Ya8 << "	Yb8 = " << Yb8 << "	Yc8 = " << Yc8 << endl; )
	DBSTREAM3( cdebug << "		Za8 = " << Za8 << "	Zb8 = " << Zb8 << "	Zc8 = " << Zc8 << endl; )
	*newX = Xr;
	*newY = Yr;
	*newZ = Zr;
}
