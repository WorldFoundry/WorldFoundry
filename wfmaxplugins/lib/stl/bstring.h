/**
 **  STL++ : The Enhanced Standard Template Library, Version 2.0
 **
 **  Copyright (c) 1994-1995 Modena Software Inc.,
 **  All Rights Reserved
 **
 **  This software is protected by international copyright laws
 **  in the United States and other countries.  Its use in any
 **  form other than that outlined in the STL++ license agreement
 **  is expressly prohibited.  The license agreement is part of
...
// Commented this out because I don't have mutex.h (and I
// don't think I will be needing it anytime soon...)
...
/*
template <class charT>
basic_string<charT>::operator vectorcharT () const _THROW_ALLOC
{
    return vectorcharT (data(), data()+length());
}
*/
template <class charT>
basic_string<charT>&
