//=============================================================================
// gfx\psx\viewport.cc: viewport hardware abstraction class, psx specific code
...
{
	_memory.Validate();
	RangeCheck(0,subdividePrimitivesCount,1000);  // kts arbitrary
	...
	for(int index=0;index<ORDER_TABLES;index++)
	{
		_orderTable[index] = new (_memory) OrderTable(orderTableDepth,_memory);
...
ViewPort::~ViewPort()
{
	for(int index=ORDER_TABLES;index>=0;index--)
