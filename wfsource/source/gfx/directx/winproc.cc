...
**  Notes:
**
**  Copyright (c) 1995 - 1997 by Microsoft, 
**-----------------------------------------------------------------------------
*/
...
void OnIdleBegin(HWND hWindow)
{
    ...
    hResult = lpd3dWindow->DrawFrameBegin ();
}
...
void OnIdleEnd(HWND hWindow)
{
    ...
    hResult = lpd3dWindow->DrawFrameEnd ();
    if (FAILED (hResult))
		return;
}


void OnIdlePageFlip(HWND hWindow)
{
    HRESULT hResult;
    LPD3DWindow  lpd3dWindow;
    ...
    hResult = lpd3dWindow->DrawFramePageFlip ();
    if (FAILED (hResult))
		return;
}
