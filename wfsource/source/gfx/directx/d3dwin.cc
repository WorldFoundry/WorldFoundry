...
HRESULT D3DWindow::DrawFrameBegin(void)
{
	...
	if (lpd3dScene)
	{
		hResult = lpd3dScene->RenderBegin ();
	}
	return hResult;
}
...
HRESULT D3DWindow::DrawFrameEnd(void)
{
    HRESULT hResult = DD_OK;
	...
	if (lpd3dScene)
	  	hResult = lpd3dScene->RenderEnd ();
	if(hResult != DD_OK)
		FatalError(__FILE__ ": RenderEnd failed");

    // Success
    return DD_OK;
}

HRESULT D3DWindow::DrawFramePageFlip(void)
{
    HRESULT hResult = DD_OK;
