...
//============================================================================
// most of this code was taken from lesson4.cpp (from the NeHe tutorials), credit follows:
/*
...
bool	windowActive=TRUE;		// Window windowActive Flag Set To TRUE By Default
...
BOOL CreateGLWindow(char* title, int xPos, int yPos, int width, int height, int bits, bool fullscreenflag)
{
	...
	WindowRect.left=(long)xPos;			// Set Left Value To 0
	WindowRect.right=(long)width;		// Set Right Value To Requested Width
	WindowRect.top=(long)yPos;				// Set Top Value To 0
							...
							LPARAM	lParam)			// Additional Message Information
{
	switch (uMsg)									// Check For Windows Messages
	{
		case WM_ACTIVATE:							// Watch For Window Activate Message
		{
			...
			{
				windowActive=TRUE;						// Program Is windowActive
			}
			else
			{
				windowActive=FALSE;						// Program Is No Longer windowActive
			}
					...
					int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("WorldFoundry",640,480,16,fullscreen))
	{
	...
	while(!done)									// Loop That Runs While done=FALSE
	{
		...
		else										// If There Are No Messages
		{
			...
			if ((windowActive && !DrawGLScene()) || keys[VK_ESCAPE])	// windowActive?  Was There A Quit Received?
			{
...
InitWindow( int xPos, int yPos, int xSize, int ySize )
{
	...
	// Create Our OpenGL Window
	if (!CreateGLWindow("WorldFoundry",xPos, yPos, xSize,ySize,16,fullscreen))
	{
		return 0;									// Quit If Window Was Not Created
	}
	return 1;
