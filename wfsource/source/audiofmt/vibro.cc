...
void
sine(short* buf, int len, float depth)
{
	int i;
	int scale = depth * 128;
...
// Process options
void
vibro_getopts(eff_t effp, int n, char* argv[] )
{
...
void
vibro_flow(eff_t effp, long* ibuf, long* obuf, int* isamp, int* osamp)
{
	vibro_t vibro = (vibro_t) effp->priv;
