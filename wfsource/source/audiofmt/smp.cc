 ...
 */
static int
readtrailer(ft_t ft, struct smptrailer* trailer)
{
	int i;
 ...
 */
static void
settrailer(ft_t ft, struct smptrailer* trailer, unsigned int rate)
{
	int i;
 ...
 */
static int
writetrailer(ft_t ft, struct smptrailer* trailer)
{
	int i;
 ...
 */
long
smpread(ft_t ft, long* buf, long len)
{
	smp_t smp = (smp_t) ft->priv;
	register long datum;
	int done = 0;
...
void
smpwrite(ft_t ft, long* buf, long len)
{
	smp_t smp = (smp_t) ft->priv;
	register int datum;
