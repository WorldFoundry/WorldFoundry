...
#ifdef	IRCAM
#include <audiofmt/sfircam.h>
#ifndef SIZEOF_BSD_HEADER
#define SIZEOF_BSD_HEADER 1024
#endif
#else
#include <audiofmt/sfheader.h>
#endif
#include <cstdlib>
#include <cstring>
 ...
 */
void
readcodes(ft_t ft, SFHEADER* sfhead)
{
