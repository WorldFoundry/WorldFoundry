...
// SMELL: convert to template, provide "globally"
 ...
 */
void
stat_getopts(eff_t effp, int n, char* argv[] )
{
 ...
 */
void
stat_flow(eff_t effp, long* ibuf, long* obuf, int* isamp, int* osamp)
{
	stat_t stat = (stat_t) effp->priv;
	int len, done;
	long samp, delta;
