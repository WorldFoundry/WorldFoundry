...
void svxwriteheader(ft_t ft,long nsamples);
...
/*======================================================================*/
long
svxread(ft_t ft, long* buf, long nsamp)
{
...
void
svxwrite(ft_t ft, long* buf, long len)
{
	struct svxpriv *p = (struct svxpriv *) ft->priv;
...
void
svxwriteheader(ft_t ft,long nsamples)
{
