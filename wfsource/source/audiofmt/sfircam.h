 ...
 * sample, and for backward compatibility, SF_SHORT and SF_cbFLOAT have
 ...
 * SFMT_cbFLOAT and we kept SF_cbFLOAT for compatibility with existing sound files.
 *
...
#define SF_cbLONG  ((long) sizeof(long) | 0x40000)
#define SF_cbFLOAT ((long) sizeof(float))
 ...
 *
 * sfclass(x) returns one of SF_SHORT, SF_cbFLOAT etc. defined above, while
